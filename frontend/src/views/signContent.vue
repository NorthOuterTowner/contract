    ...
    <div class="content">
      ...
      <div v-else-if="contract" class="details-box">
        ...
        <div class="approval-box">
          <h3 class="sub-title">签订信息</h3>
          <textarea v-model="form.comment" class="textarea" placeholder="签订意见..."></textarea>
...
export default {
  ...
  methods: {
    async fetchContractContent(id) {
      try {
        const res = await axios.get('/sign/content', {
          params: { id }
        });
    ...
    async submitApproval() {
      ...
      try {
        const res = await axios.post('/sign/determine', {
