...
(3,'用户管理','系统用户配置与维护',NULL,'/user','2025-06-07 01:40:33'),
(4,'角色管理','系统角色配置与维护',NULL,'/role','2025-06-07 01:40:33'),
(5,'功能操作','系统功能配置与维护',NULL,'/function','2025-06-07 01:40:33'),
(6,'权限管理','系统权限分配与管理',NULL,'/permission','2025-06-07 01:40:33'),
(7,'客户管理','客户信息维护与管理',NULL,'/customerInfo','2025-06-07 01:40:33'),
(8,'起草合同','创建新合同文档',1,'/DraftContract','2025-06-07 01:40:33'),
(9,'定稿合同','完成合同定稿流程',1,'/FinalizeContract','2025-06-07 01:40:33'),
(10,'查询合同','查询和浏览合同文档',1,'/query','2025-06-07 01:40:33'),
(11,'删除合同','删除不需要的合同',1,'','2025-06-07 01:40:33'),
(12,'会签合同','执行合同会签流程',2,'/CoSignContract','2025-06-07 01:40:33'),
(13,'审批合同','执行合同审批流程',2,'/approveList','2025-06-07 01:40:33'),
(14,'签订合同','执行合同签订流程',2,'/SignContractList','2025-06-07 01:40:33'),
(15,'分配会签','分配会签人员和顺序',2,'/PendingContractList','2025-06-07 01:40:33'),
(16,'分配审批','分配审批人员和顺序',2,'','2025-06-07 01:40:33'),
(17,'分配签订','分配签订人员和顺序',2,'','2025-06-07 01:40:33'),
(18,'流程查询','查询和跟踪流程状态',2,'','2025-06-07 01:40:33'),
(19,'新增用户','创建新系统用户',3,'/user/add','2025-06-07 01:40:33'),
(20,'编辑用户','修改现有用户信息',3,'/user/modify/\\d+','2025-06-07 01:40:33'),
(21,'查询用户','查询和浏览用户信息',3,'/user','2025-06-07 01:40:33'),
(22,'删除用户','删除系统用户',3,'/user','2025-06-07 01:40:33'),
(23,'新增角色','创建新系统角色',4,'/role/add','2025-06-07 01:40:33'),
(24,'编辑角色','修改现有角色信息',4,'/role/modify/\\d+','2025-06-07 01:40:33'),
(25,'查询角色','查询和浏览角色信息',4,'/role','2025-06-07 01:40:33'),
(26,'删除角色','删除系统角色',4,'/role','2025-06-07 01:40:33'),
(27,'新增功能','创建新系统功能',5,'/function/add','2025-06-07 01:40:33'),
(28,'编辑功能','修改现有功能信息',5,'','2025-06-07 01:40:33'),
(29,'查询功能','查询和浏览功能信息',5,'/function/query','2025-06-07 01:40:33'),
(30,'删除功能','删除系统功能',5,'/function/delete','2025-06-07 01:40:33'),
(31,'配置权限','分配角色和用户权限',6,'/permission/assign/\\d+','2025-06-07 01:40:33'),
