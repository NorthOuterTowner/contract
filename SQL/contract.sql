...
('AI001','Resnet结构图','图为renet的模块结构','ResNet.png','已签订','2025-06-02 10:51:47','2025-06-02 11:07:06'),
('SAD001','软件系统分析与设计Logo','软件系统分析与设计的Logo图标。','SADLogo.png','待签订','2025-06-02 10:53:08','2025-06-02 10:59:19');
UNLOCK TABLES;
...
(0, 31),
-- 流程管理模块
(0, 2), (0, 15), (0, 16), (0, 17), (0, 18),
-- 客户管理模块
(0, 7), (0, 32), (0, 33), (0, 34), (0, 35),
-- 合同操作员权限
